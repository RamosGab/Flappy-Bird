...
class Bird(pygame.sprite.Sprite):
    ...
    def update(self):
        self.currennt_image = (self.currennt_image + 1) % 3
        self.image = self.images[ self.currennt_image ]

        self.speed += GRAVITY

        # Update heigth from bird
